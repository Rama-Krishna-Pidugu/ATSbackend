...
from app.routes import resume, search, email, background, screen
from app.models import init_db
from dotenv import load_dotenv
from pathlib import Path
from app.auth.clerk import get_current_user, verify_clerk_token
...
# Load dotenv always for local development if file exists
if ENV_PATH.exists():
...
@app.get("/")
async def root():
    return {"message": "Welcome to HireSenstry APIs from hireAI"}
